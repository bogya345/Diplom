...
@Component({
  selector: 'app-themesforpdf',
  templateUrl: './themesforpdf.component.html',
  styleUrls: ['./themesforpdf.component.css']
})
export class ThemesforpdfComponent implements OnInit {
